 ...
 * version 0.91
 * 
 * An input text field for allowing a user to enter a single line of text.
 * 
	...
	public class InputText extends Component
	{
		...
		override protected function addChildren():void
		{
			...
			if (Locale.language == "ja") {
				_tf.defaultTextFormat = new TextFormat(null, 12, Style.INPUT_TEXT);
			} else {
				_tf.embedFonts = true;
				_tf.defaultTextFormat = new TextFormat("PF Ronda Seven", 12, Style.INPUT_TEXT);
			}
			addChild(_tf);
		...
		override public function draw():void
		{
			...
			_back.graphics.beginFill(0xF5F5F5);
