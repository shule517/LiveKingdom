...
package com.bit101.components
{
	...
	public class PushButton extends Component
	{
		 ...
		 */
		public function PushButton(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number =  0, label:String = "", B_COLOR:uint = 0xFFFFFF, defaultHandler:Function = null)
		{
		...
		override public function draw():void
		{
			...
			var filtype:String = GradientType.RADIAL;
			var colors:Array = [0xFFFFFF, ButtonColor];
			var alphas:Array = [1, 1];
			var ratios:Array = [0x00, 0xFF];
			matr.createGradientBox(_width, _height, 0, 0, 0);
			var spreadMethod:String = SpreadMethod.PAD;
			//_face.graphics.beginFill(Style.BUTTON_FACE);
			_face.graphics.beginGradientFill(filtype, colors, alphas, ratios, matr, spreadMethod );
