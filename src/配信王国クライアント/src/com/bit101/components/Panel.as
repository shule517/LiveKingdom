...
package com.bit101.components
{
	...
	public class Panel extends Component
	{
		 ...
		 */
		public function Panel(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number =  0, COLOR:uint = 0xFFFFFF, ALPHA:Number = 0 )
		{
			_backcolor = COLOR;
			_backalpha = ALPHA;
		...
		override public function draw():void
		{
			...
			if(_color == -1)
			{
				_background.graphics.beginFill(_backcolor,_backalpha);
			}
			else
			{
