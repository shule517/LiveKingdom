...
package com.bit101.components
{
	...
	public class Slider extends Component
	{
		...
		private var _backColor:Sprite;
		private var _backClick:Boolean = false;
		protected var _value:Number = 30;
		...
		override protected function addChildren():void
		{
			...
			_backColor = new Sprite();
			_backColor.filters = [getShadow(2, true)];
			addChild(_backColor);
		...
		protected function drawBack():void
		{
			...
			_back.graphics.moveTo(_width-200, _height);
			_back.graphics.lineTo(_width, _height);
			_back.graphics.lineTo(_width, _height - 8);
		...
		{	
			...
			if(_orientation == HORIZONTAL)
			{
				_handle.graphics.drawRect(1, 1, _height,_height+5);
			}
			else
			{
		...
		protected function drawBackColor():void
		{
			_backColor.graphics.clear();
			_backColor.graphics.beginFill(0x00BFFF);
			var BC_height:int = 8 / _width * _value *2;
			if (_orientation == HORIZONTAL)
			{
				_backColor.graphics.moveTo(_width - 200, _height);
				_backColor.graphics.lineTo(_value * 2 + _width - 200, _height);
				_backColor.graphics.lineTo(_value * 2 + _width - 200, _height - BC_height);
